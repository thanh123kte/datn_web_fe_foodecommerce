...
export default function AdminForgotPasswordPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Nhập email quản trị viên để nhận liên kết đặt lại mật khẩu"
      leftPanelContent={{
        title: "Khôi phục tài khoản Admin",
        description: "Bảo mật cao - Chỉ dành cho quản trị viên hệ thống",
        stats: [
          {
            value: "Xác thực",
            label: "Bảo mật 2 lớp",
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Nhập email quản trị viên đã được cấp
            </p>
          </div>
